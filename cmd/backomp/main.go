...
func runTestsForVersion(conf conf, dirname string) (bool, error) {
...
func runTest(conf conf, fname string) (pass bool, err error) {
...
func getResponses(conf conf, fname string) (target, base *http.Response, path string, err error) {
